...
integer i,j,l,m,quad_order,io,jx,quad_order_2

quad_order=0
open(1,file='quad_b10_x.txt')
do
read(1,*,iostat=io)
if(io.ne.0) exit
...
open(20,file='./data/rho_x_effective_a1_b10.dat')
open(22,file='./data/rho_x_effective_quadrature_a1_b10.dat')
open(33,file='./data/rho_x_effective_nonorm_a1_b10.dat')


open(10, file='quad_b10_w.txt')
open(11, file='quad_b10_x.txt')
...
call calculanorma(quad_order,alpha,beta,norm)
!print*, norm
...
J_x = 0.; rhoint1 = 0.; rhoint2 = 0.;rhoint3 = 0.!; intJ_x = 0.
do i=1, quad_order
...
!norm = (5.91572988137469783E-003,2.16613318451298365E-022) ! from exact formua, quadrature 101, -10, 10
!norm = 1.
!print*, norm
print*, x, rho/norm
...
read(1,*,iostat=io)
if(io.ne.0) exit
quad_order_2 = quad_order_2 + 1
enddo
close(1)

allocate(quad_w_2(quad_order_2)); allocate(quad_x_2(quad_order_2))



open(10, file='quadrature2_w.txt')
open(11, file='quadrature2_x.txt')
...
do jx=1,quad_order_2
x = quad_x_2(jx); w_x = quad_w_2(jx)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine calculanorma(quad_order,alpha,beta,norm)
implicit none
character (len = 6) answer
