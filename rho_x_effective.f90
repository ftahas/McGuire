...
open(20,file='./data/rho_x_effective_a0_b5.dat')
open(22,file='./data/rho_x_effective_quadrature_a0_b5.dat')
...
quad_order3=0
open(1,file='quadrature3_x.txt')
do
read(1,*,iostat=io)
if(io.ne.0) exit
quad_order3 = quad_order3 + 1
enddo
close(1)
...
allocate(quad3_w(quad_order3)); allocate(quad3_x(quad_order3))
...
open(98, file='quadrature3_w.txt')
open(99, file='quadrature3_x.txt')
